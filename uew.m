...
% Double logarithmic curves of concentration of pollutant at the wellhead in real-space 
loglog(t,ft(:,1), 'k-','Linewidth',1.)
hold on 
...
xlabel({'$$t (h)$$ ','','Figure 8 Concentration curves of the effect of $$\mu_{e,w}(0,0,H,t)$$'},'FontName','Times New Roman','FontSize',10,'Interpreter','latex') 
ylabel('$$\mu_{ew} (mg/L)$$' ,'FontName','Times New Roman','FontSize',10,'Interpreter','latex')
legend('$$ \mu_{ew} $$','$$ Actual\ data $$','Interpreter','latex')
grid on  